...
export const IdleState: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					'Converter in idle state with Convert button ready. Click "Convert to WebP" to start conversion.',
			},
		},
	},
};
...
export const MediumFile: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Converter with a medium-sized file (5MB). Note: Actual conversion requires Web Worker which is not available in Storybook.",
			},
		},
	},
};
...
export const LargeFile: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Converter with a large file (50MB). Shows memory warning for files over recommended size.",
			},
		},
	},
};
...
export const WithMemoryWarning: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Converter displaying memory warning for large files (>100MB recommended limit)",
			},
		},
	},
};
