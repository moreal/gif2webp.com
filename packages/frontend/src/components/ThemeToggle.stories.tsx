...
export const Default: Story = {
	parameters: {
		docs: {
			description: {
				story:
					"Theme toggle button that cycles through light/dark modes. Click to toggle theme.",
			},
		},
	},
};
...
export const WithSystemPreference: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					'When using system theme preference, displays "(System)" label with light theme',
			},
		},
	},
};
