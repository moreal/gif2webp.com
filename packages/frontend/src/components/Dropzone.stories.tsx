...
export const Default: Story = {
	parameters: {
		docs: {
			description: {
				story:
					"Default dropzone state. Drag and drop GIF files or click to select.",
			},
		},
	},
};
...
export const DragActive: Story = {
	parameters: {
		docs: {
			description: {
				story:
					"Dropzone when files are being dragged over it. (Simulate by dragging files over the component)",
			},
		},
	},
};
...
export const LoadingState: Story = {
	parameters: {
		docs: {
			description: {
				story:
					"Dropzone in loading state while processing files. This state is shown automatically when files are being read.",
			},
		},
	},
};
